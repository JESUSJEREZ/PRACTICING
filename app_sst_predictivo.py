"""
App SST Predictivo — Modelo de Riesgo de Incapacidad
Basado en datos reales de accidentalidad (PREVSIS 2024-2026)
Ejecutar: streamlit run app_sst_predictivo.py
"""
...
def load_data(uploaded_file=None):
    if uploaded_file is not None:
        ...
        partes = ["1.Espalda","1.Oreja (oido)","1.Manos","1.Dedos de mano","1.Pie",
                  "1.Múltiples partes","1.Cabeza","1.Lesiones generales u otros"]
        ...
        data = {
            ...
            "Puesto/Cargo": np.random.choice(cargos, size=n,
                            p=[0.28,0.10,0.04,0.03,0.03,0.03,0.03,0.03,0.02,0.39]),
...
model, X_train, X_test, y_train, y_test, y_pred, y_prob, cv_scores, feat_cols = \
    train_model(mdf, target=target_var, model_type=model_type)
